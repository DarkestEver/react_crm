        ...
        <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
          ...
          <div className="relative z-20 mt-auto">
            <blockquote className="space-y-2">
              <p className="text-lg">
                &ldquo;Keshav's CRM revolutionized how I manage client relationships — effortless, 
                organized, and data-driven decisions. A game-changer for my business!&rdquo;
              </p>
